...
namespace Cadastros.Infra.Data.Migrations
{
    ...
    [Migration("20230306193010_adicionando o PessoaFisica")]
    partial class adicionandooPessoaFisica
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cadastros.Domain.Entities.Telefone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cadastros.Domain.Entities.Telefone", b =>
                {
                    b.HasOne("Cadastros.Domain.Entities.Fornecedor", null)
                        .WithMany("TelefonesList")
